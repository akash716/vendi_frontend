...
function CandyCardSingle({ c, onSelect, mobile, imgH }) {
  ...
  return (
    <div
      ...
      onTouchStart={(e) => {
        if (!outOfStock) e.currentTarget.style.transform = "scale(.96)";
      }}
      onTouchEnd={(e) => {
...
export default function SingleGrid({ candies = [], onSelect, onCancel, mobile }) {
  ...
  if (!candies.length)
    return (
      <p style={{ color: "var(--cream1)", textAlign: "center", padding: 40, fontSize: 13 }}>
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "center", marginBottom: 20 }}>
            ...
            <h3 style={{ margin: "0 0 5px", fontSize: mobile ? "1.15rem" : "1.3rem" }}>
              Select Category
            </h3>
            <p style={{ fontSize: 12, color: "var(--cream1)", margin: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
            {categories.map((cat, idx) => {
              ...
              const inStock = candies.filter(
                (c) => (c.category || "Other") === cat && (c.stock ?? 0) > 0
              ).length;
              return (
                <button
                  key={cat}
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    />
                    <span style={{ fontWeight: 700, fontSize: mobile ? 15 : 16, color: pal.text }}>
                      {cat}
                    </span>
                  </div>
                  <span
  ...
  return (
    <div style={{ maxWidth: maxW }}>
      ...
      >
        ...
        {/* Other category quick-switch (desktop only) */}
        {!mobile &&
          categories
